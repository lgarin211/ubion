  ...
  useEffect(() => {
    ...
    if (info) {
      ...
      try {
        ...
        history.unshift({ ...parsed, trxid, status: 'cancelled', date: new Date().toISOString() });
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 text-gray-800">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        <h1 className="text-3xl font-bold mb-4 text-gray-700">Pembayaran Dibatalkan</h1>
        ...
        {paymentInfo ? (
          <>
            ...
            <p className="mb-2">Status: <span className="text-gray-700 font-semibold">Dibatalkan</span></p>
          </>
        ) : (
          <p className="mb-2">Pembayaran Anda telah dibatalkan.</p>
        )}
