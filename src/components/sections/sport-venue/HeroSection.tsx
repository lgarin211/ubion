    ...
    <section className="relative h-[600px] bg-gradient-to-r from-black to-gray-800">
      <div className="absolute inset-0 bg-black/60">
        <div className="container mx-auto px-6 py-32">
          <h1 className="text-5xl font-bold text-white mb-4">Sport Venue<br />Locations</h1>
          <p className="text-gray-200 mb-8 max-w-xl">
            Discover our world-class sports facilities designed for athletes of all levels.
          </p>
